# CCF Proposal for LFG-Crew-Compensation 
## Overview
...
Total allocation percentage: 18,70% 
...
Total allocation percentage: 15,69%
...
Total allocation percentage: 22,54%
...
Total allocation percentage: 20,44% 
...
### LFG Discord 机器人
#### 项目概述
LFG 机器人是一个 Discord 实用工具，旨在为用户简化信息获取。它将生态系统各部分的数据聚合成一个中心化枢纽，用户可以通过简单命令快速高效地获取相关信息。这消除了导航多个来源的需要，使体验对所有用户更加友好和易于访问，无论他们对生态系统的熟悉程度如何。
...
#### 影响
简化用户对生态系统数据的访问，促进包容性和参与度。

### Qubic Whale Alert
#### 项目概述
Qubic Whale Alert 是一个监控 Qubic 生态系统内所有交易的机器人，仅公开发布超过特定阈值的交易。由于加密货币领域对 whale alert 账户的高需求，它成为生态系统中一个必不可少的工具。
...
#### 影响
满足对交易透明度的高需求，建立生态系统的信任。

### Monero 交易机器人
#### 项目概述
一个持续进化、完全自动化的交易解决方案，通过复杂且适应性强的策略优化 Qubic 燃烧。

**总分配百分比**：22.54%

#### 关键绩效指标 (KPIs)
- 6月/7月燃烧约 457,588,580,489 Qubic
- 预计每年燃烧 1.2 万亿 Qubic
- 平均每周 20,000 次交易

#### 影响
通过减少供应量增强代币经济性，可能提升 Qubic 的价值。

### Qx - Qubictrade.com
#### 项目概述
Qubictrade.com 是一个创新且用户友好的界面，旨在为 Qx 提供无缝访问，提供媲美传统中心化交易所的交易功能。持续以卓越为目标进行开发，Qubictrade 旨在成为 Qubic 生态系统中领先的去中心化交易所（DEX）界面。
...
- 总计 320,000 次请求
- 6月高峰：191,000 次请求
- 用户分布：60% 移动端，31% 桌面端，9% 其他
- 首个支持资产发行的 Qubic DEX

#### 影响
将 Qubic 定位为领先的 DEX，推动采用和流动性。

### 其他贡献
除了这些项目外，LFG Crew 还为主要交易所（如 MEXC、Gate.io）提供了持续支持，并开发了 Qubic 库，确保 Qubic 对全球用户的无缝整合和可访问性。这包括技术协助、故障排除和协作以维护强大的交易基础设施。此外，LFG 还为关键开发举措做出了贡献，例如远程过程调用（RPC）系统和定制挖矿解决方案，这些举措增强了生态系统的功能性和可扩展性。过去一年中数千小时的工作为加强 Qubic 的技术基础和市场地位发挥了重要作用。
