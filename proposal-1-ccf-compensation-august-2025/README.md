...
> Option 1: Approve compensation of 175 billion Qubic
...
## 提案
基于LFG团队的贡献及其项目所产生的显著影响，我们向Qubic计算器提出以下建议：

将1750亿Qubic发送至LFG团队地址 `LFGCREWZGFRGGCYEWHGZWFOMAUVCDRWVAPWMLCJMPDFDTPKYKBDHFLBFRKMO`
...
### LFG Discord Bot
#### 项目简介
LFG机器人是一个旨在为用户简化信息访问的Discord工具。它将生态系统中各个部分的数据整合到一个中心化平台，允许用户通过简单的命令快速有效地检索相关信息。这消除了浏览多个来源的需要，无论用户对生态系统熟悉程度如何，都能获得更友好的体验。
#### 关键绩效指标 (KPIs)
* 2,000名独立用户
* 推出以来总互动次数达26,000次
* 为小型开发者和创作者提供曝光度。
...
### Qubic Whale-Alert (鲸鱼预警)
#### 项目简介
Qubic鲸鱼预警是一个监控Qubic生态系统中所有交易的机器人，并公开仅发布超过特定阈值的交易。其受欢迎程度源于加密货币领域对“鲸鱼预警”账户的高度需求，使其成为生态系统中的重要工具。
#### 关键绩效指标 (KPIs)
* 3,034个帖子
* 1,000,000次曝光
* 3.6%的参与率（36,000次互动）
#### 影响
满足了对交易透明度的高需求，增强了生态系统的信任。


### 门罗币交易机器人
#### 项目简介
一个持续演进、全自动的交易解决方案，旨在通过复杂而自适应的策略优化Qubic的销毁。
#### 绩效指标 (KPIs)
* 6月/7月销毁了约457,588,580,489 Qubic
* 预计每年销毁1.2万亿Qubic
* 平均每周进行20,000次交易
#### 影响
通过减少供应量来增强代币经济学，有可能增加Qubic的价值。

### Qx - Qubictrade.com
#### 项目简介
Qubictrade.com是一个创新的、用户友好的界面，旨在提供对Qx的无缝访问，其交易能力可与传统的中心化交易所媲美。Qubictrade持续以卓越为目标进行开发，旨在成为Qubic生态系统中首屈一指的去中心化交易所（DEX）界面。
#### 关键绩效指标 (KPIs)
* 总请求数320,000次
* 6月峰值：191,000次请求
* 用户分布：60%移动设备，31%桌面，9%其他
* 首个支持资产发行的Qubic DEX
#### 影响
将Qubic定位为领先的DEX，推动采用和流动性。
